    ...
    """ One externally-executed prompt run submitted for ingestion.
        ...
        Attributes:
            ...
            contribute (bool | Unset): Opt this run into the anonymous benchmark. Defaults to false. A true value with no
                per-project KEK is rejected 403 kek_missing. Note: full contribute enforcement requires Story 40.4; until then a
                true request is honoured only as far as the KEK gate. Default: False.
     """

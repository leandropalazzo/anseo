...
if TYPE_CHECKING:
  from ..models.citation_summary_response_domains_item import CitationSummaryResponseDomainsItem
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _domains is not UNSET:
            ...
            for domains_item_data in _domains:
                domains_item = CitationSummaryResponseDomainsItem.from_dict(domains_item_data)

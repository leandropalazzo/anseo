...
from ...models.list_marketplace_plugins_response_200 import ListMarketplacePluginsResponse200
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | ListMarketplacePluginsResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | ListMarketplacePluginsResponse200]:
    return Response(

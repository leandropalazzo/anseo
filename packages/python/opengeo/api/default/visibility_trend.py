...
from ...models.visibility_trend_response import VisibilityTrendResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | VisibilityTrendResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | VisibilityTrendResponse]:
    return Response(

...
from ...models.sm_14_metric_response import Sm14MetricResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/recommendations/metrics",
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | Sm14MetricResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | Sm14MetricResponse]:
    return Response(

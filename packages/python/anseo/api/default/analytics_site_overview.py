...
from ...models.analytics_site_overview_period import AnalyticsSiteOverviewPeriod
from ...models.analytics_site_overview_response_200 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/site-overview",
        "params": params,
    }

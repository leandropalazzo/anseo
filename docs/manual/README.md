...
The **MIT OSS core** covers: data collection, extraction, analytics, crawler ingestion, audit heuristics, recommendations, multi-project support, `anseo serve`, the plugin host and marketplace OSS parts, and all SDKs. This manual set documents only OSS-canonical surfaces.
